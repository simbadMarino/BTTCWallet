const i18n_fa = {
    ...
    login: {
        title: 'به کیف پول BTTC خوش آمدید',
    ...
    receive: {
        ...
        receive_amount: 'مقدار دریافتی (BTTC)',
    ...
    transfer: {
        ...
        fields: {
            ...
            amount: 'مقدار',
            transfer_amount: 'مقدار انتقالی (BTTC)'
        },
        ...
        prompt: {
            verify_transfer: {
                title: 'تأیید انتقال',
                text: 'شما در حال انتقال {amount} BTTC با کارمزد {fee} BTTC به {destination} هستید. آیا می‌خواهید ادامه دهید؟',
            },
        }
    },
    api: {
