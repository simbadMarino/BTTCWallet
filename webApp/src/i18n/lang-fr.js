const i18n_fr = {
    general: {
        title: 'Portefeuille BTTC',
        language: 'Français',
        yes: 'Oui',
        no: 'Non',
    },
    login: {
        title: "Bienvenue sur BTTC Wallet",
    ...
    receive: {
        ...
        receive_amount: 'Montant Reçu (BTTC)',
    ...
    transfer: {
        ...
        fields: {
            ...
            amount: 'Montant',
            transfer_amount: 'Montant du Transfert (BTTC)'
        },
        ...
        prompt: {
            verify_transfer: {
                ...
                text: 'Vous transférez {amount} BTTC avec des frais de {fee} BTTC vers {destination}. Voulez-vous continuer ?',
            },
        }
    },
    api: {
