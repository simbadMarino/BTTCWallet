const i18n_tr = {
    ...
    login: {
        title: "BTTC Cüzdan'a Hoş Geldiniz",
    ...
    receive: {
        ...
        receive_amount: 'Alınan Miktar (BTTC)',
    ...
    transfer: {
        ...
        fields: {
            ...
            amount: 'Miktar',
            transfer_amount: 'Transfer Miktarı (BTTC)'
        },
        ...
        prompt: {
            verify_transfer: {
                ...
                text: '{amount} BTTC ve {fee} BTTC ücret ile {destination} adresine transfer yapmak üzeresiniz. Devam etmek istiyor musunuz?',
            },
        }
    },
    api: {
