const i18n_ar = {
    ...
    receive: {
        ...
        receive_amount: 'المبلغ المستلم (BTTC)',
    ...
    transfer: {
        ...
        fields: {
            ...
            amount: 'المبلغ',
            transfer_amount: 'مبلغ التحويل (BTTC)'
        },
        ...
        prompt: {
            verify_transfer: {
                title: 'تأكيد التحويل',
                text: 'أنت على وشك نقل {amount} BTTC برسوم قدرها {fee} BTTC إلى {destination}. هل ترغب في المتابعة؟',
            },
        }
    },
    api: {
