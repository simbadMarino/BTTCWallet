const i18n_de = {
    general: {
        title: 'BTTC Brieftasche',
        language: 'Deutsch',
        yes: 'Ja',
        no: 'Nein',
    },
    login: {
        title: "Willkommen bei BTTC Wallet",
    ...
    receive: {
        ...
        receive_amount: 'Erhaltener Betrag (BTTC)',
    ...
    transfer: {
        ...
        fields: {
            ...
            amount: 'Betrag',
            transfer_amount: 'Überweisungsbetrag (BTTC)'
        },
        ...
        prompt: {
            verify_transfer: {
                ...
                text: 'Sie überweisen {amount} BTTC mit einer Gebühr von {fee} BTTC an {destination}. Möchten Sie fortfahren?',
            },
        }
    },
    api: {
